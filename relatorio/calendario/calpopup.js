...
function Calendar() {
	...
	this.daysOfWeek = "Dom Seg Ter Qua Qui Sex Sáb".split(" ");
	this.months = "Janeiro Fevereiro Março Abril Maio Junho Julho Agosto Setembro Outubro Novembro Dezembro".split(" ");
...
Calendar.prototype.buildString = function(){
	...
	tmpStr += '<thead><tr><td colspan="7"><ul>\n'+
			'<li id="cp_prevMonth"><a href="javascript:g_Calendar.changeMonth(-1)" title="Vai para o mês anterior"><span>&lt;</span></a></li>\n'+
			'<li id="cp_monthMenu"><a href="javascript:g_Calendar.openMenuMonths()" title="Abre o menu de meses">' + this.months[this.month] + '</a>\n' +
			'<ul id="cp_months"><li><a href="javascript:g_Calendar.clickMonth(0)">Janeiro</a></li><li><a href="javascript:g_Calendar.clickMonth(1)">Fevereiro</a></li><li><a href="javascript:g_Calendar.clickMonth(2)">Março</a></li><li><a href="javascript:g_Calendar.clickMonth(3)">Abril</a></li><li><a href="javascript:g_Calendar.clickMonth(4)">Maio</a></li><li><a href="javascript:g_Calendar.clickMonth(5)">Junho</a></li><li><a href="javascript:g_Calendar.clickMonth(6)">Julho</a></li><li><a href="javascript:g_Calendar.clickMonth(7)">Agosto</a></li><li><a href="javascript:g_Calendar.clickMonth(8)">Setembro</a></li><li><a href="javascript:g_Calendar.clickMonth(9)">Outubro</a></li><li><a href="javascript:g_Calendar.clickMonth(10)">Novembro</a></li><li><a href="javascript:g_Calendar.clickMonth(11)">Dezembro</a></li></ul></li>\n' +
			'<li id="cp_nextMonth"><a href="javascript:g_Calendar.changeMonth(1)" title="Vai para o próximo mês"><span>&gt;</span></a></li>\n' +
			'<li id="cp_prevYear"><a href="javascript:g_Calendar.changeYear(-1)" title="Ir para o ano anterior"><span>&lt;</span></a></li>\n' +
			'<li id="cp_yearMenu"><a href="javascript:g_Calendar.openMenuYears();" title="Abrir o menu de anos">' + this.year + '</a>\n';
	...
	tmpStr += '</ul></li>\n<li id="cp_nextYear"><a href="javascript:g_Calendar.changeYear(1)" title="Vai para o próximo ano"><span>&gt;</span></a></li>\n</ul></td></tr>';
	...
	tmpStr += '</tr></thead><tfoot><tr><td colspan="7">Hoje é: <a href="javascript:g_Calendar.clickToday()" title="Go to current month">' + (/^d/.test(this.dateFormat)?dtToday.getDate() + ' ' + this.months[dtToday.getMonth()] + ' ':this.months[dtToday.getMonth()] + ' ' + dtToday.getDate() + ', ') + dtToday.getFullYear()+'</a></td></tr></tfoot><tbody>';
