        ...
        <table style="width:100%">
            <tr>
                <th> <img src="../img/arranchamento_72x72.png" height="48">
                    <font style="font-size:16px;margin-left:10px;position: relative;top: 7px"><b>Opções de Relatório</font>
                </th>
                <th >
        ...
        <div class="form-group" style="width:230px;margin-left:auto;margin-right:auto;">  
            <div class="col-md-10" style="padding:0px">
               <div class="radio radio-primary" >
                           ...
                           <label><input name="optionsRadios" id="optionsRadios2" value="arranchamento.hierarquia>=7 and arranchamento.hierarquia<=10 and militares.tipo_acesso<>'ALUNO'" type="radio">Sub Ten e Sgt</label><br>
                           <label><input name="optionsRadios" id="optionsRadios3" value="arranchamento.hierarquia>=11 and arranchamento.hierarquia<=12 and militares.tipo_acesso<>'ALUNO'" type="radio">Cabos e Soldados</label><br>
                           <label><input name="optionsRadios" id="optionsRadios4" value="militares.tipo_acesso='ALUNO'" type="radio" type="radio">Todos os Alunos</label><br>
                           <label><input name="optionsRadios" id="optionsRadios2" value="arranchamento.hierarquia=7 and militares.tipo_acesso='ALUNO'" type="radio">Alunos - Adj Cmdo</label><br>                       
                           <label><input name="optionsRadios" id="optionsRadios5" value="militares.turma='TURMA 1' and militares.tipo_acesso='ALUNO'" type="radio">Alunos - Turma 1</label><br>
                           <label><input name="optionsRadios" id="optionsRadios6" value="militares.turma='TURMA 2' and militares.tipo_acesso='ALUNO'" type="radio">Alunos - Turma 2</label><br>
                           <label><input name="optionsRadios" id="optionsRadios7" value="militares.turma='TURMA 3' and militares.tipo_acesso='ALUNO'" type="radio">Alunos - Turma 3</label><br>
                           <label><input name="optionsRadios" id="optionsRadios8" value="militares.turma='TURMA 4' and militares.tipo_acesso='ALUNO'" type="radio">Alunos - Turma 4</label><br>
                           <label><input name="optionsRadios" id="optionsRadios9" value="militares.turma='TURMA 5' and militares.tipo_acesso='ALUNO'" type="radio">Alunos - Turma 5</label><br>
                           <label><input name="optionsRadios" id="optionsRadios10" value="militares.turma='TURMA 6' and militares.tipo_acesso='ALUNO'" type="radio">Alunos - Turma 6</label><br>
                           <label><input name="optionsRadios" id="optionsRadios11" value="militares.turma='TURMA 7' and militares.tipo_acesso='ALUNO'" type="radio">Alunos - Turma 7</label>
